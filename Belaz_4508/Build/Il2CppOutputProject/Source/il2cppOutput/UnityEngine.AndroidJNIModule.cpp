...
IL_021a:
	{
		...
		NullCheck(L_78);
		bool L_81;
		L_81 = VirtualFuncInvoker1< bool, Type_t* >::Invoke(120, L_78, L_80);
		V_17 = L_81;
		bool L_82 = V_17;
		if (!L_82)
		{
...
IL_023c:
	{
		...
		NullCheck(L_83);
		bool L_86;
		L_86 = VirtualFuncInvoker1< bool, Type_t* >::Invoke(120, L_83, L_85);
		V_18 = L_86;
		bool L_87 = V_18;
		if (!L_87)
		{
...
IL_025e:
	{
		...
		NullCheck(L_88);
		bool L_91;
		L_91 = VirtualFuncInvoker1< bool, Type_t* >::Invoke(120, L_88, L_90);
		V_19 = L_91;
		bool L_92 = V_19;
		if (!L_92)
		{
...
IL_02da:
	{
		RuntimeTypeHandle_t332A452B8B6179E4469B69525D0FE82A88030F7B L_106 = { reinterpret_cast<intptr_t> (&il2cpp_defaults.array_class->byval_arg) };
		il2cpp_codegen_runtime_class_init_inline(il2cpp_defaults.systemtype_class);
		Type_t* L_107;
